...
def triplet_loss(alpha = 0.2, batch_size = 32):
    def _triplet_loss(y_true, y_pred):
        ...
        # 期待：posdist递增， neg_dist 递减
        basic_loss = pos_dist - neg_dist + alpha
        
        # 将basic_loss > 0 大于零的结果筛选出来，进行下一轮的运算， < 0 的样本表示训练的结果已经很好，不需要对该样本继续训练了
...
class FacenetDataset(keras.utils.Sequence):
    ...
    def __getitem__(self, index):
        ...
        # 对 images 进行分割，再拼接，以达到减少images维度的目的
